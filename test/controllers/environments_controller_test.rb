...
class EnvironmentsControllerTest < ActionController::TestCase
  ...
  test "should create environment" do
    assert_difference('Environment.count') do
      post :create, environment: { application_id: @environment.application_id, decription: @environment.decription, name: @environment.name }
    end
  ...
  test "should update environment" do
    patch :update, id: @environment, environment: { application_id: @environment.application_id, decription: @environment.decription, name: @environment.name }
    assert_redirected_to environment_path(assigns(:environment))
  end
